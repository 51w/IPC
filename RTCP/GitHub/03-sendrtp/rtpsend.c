...
{    
    ...
    {    
		...
		//send_rtp(n->buf,n->len, n->nal_unit_type, ts_current);
        ...
        if(n->len<=UDP_MAX_SIZE){    
            ...
            // fu_ind->TYPE=28;
			sendbuf[12] = 0x1c | (n->buf[0] & ~0x1F);
			sendbuf[13] = (1<<7) | n->nal_unit_type;
            ...
            {    
                ...
                // fu_hdr->TYPE=n->nal_unit_type;  
				sendbuf[12] = 0x1c | (n->buf[0] & ~0x1F);
				sendbuf[13] = (0<<7) | n->nal_unit_type;				
            ...
            // fu_hdr->TYPE=n->nal_unit_type;  
			sendbuf[12] = 0x1c | (n->buf[0] & ~0x1F);
			sendbuf[13] = (1<<6) | n->nal_unit_type;			
